...
*/
int signal_calc_init(GRETA_Siggen_Setup *setup, int *nsegments);
 ...
 */
int get_signal(GRETA_Siggen_Setup *setup, point pt, float **signal);
...
*/
int drift_path_e(GRETA_Siggen_Setup *setup, point **path);
int drift_path_h(GRETA_Siggen_Setup *setup, point **path);
